...
contract samsonDemoNFT is ERC1155, Ownable {
    ...
    string private baseURI = "ipfs://YOUR_IPFS_HOST/{id}.json";
    string public name = "SAMSON Collection"; //set ERC1155 contract name
